...
describe('Export Orchestrator', () => {
  it('getFormatsForContext returns correct formats', () => {
    assert.deepStrictEqual(getFormatsForContext('workflow'), ['json', 'markdown', 'mermaid', 'clipboard']);
    assert.deepStrictEqual(getFormatsForContext('search'), ['json', 'jsonl', 'csv', 'markdown', 'clipboard']);
    assert.deepStrictEqual(getFormatsForContext('chat'), ['json', 'markdown', 'clipboard']);
    assert.deepStrictEqual(getFormatsForContext('benchmark'), ['json', 'csv', 'markdown', 'clipboard']);
    assert.deepStrictEqual(getFormatsForContext('explore'), ['json']);
