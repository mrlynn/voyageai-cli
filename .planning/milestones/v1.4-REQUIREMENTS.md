# Requirements Archive: v1.4 Chat Experience Overhaul
...
- [x] **KBIN-02**: User can paste text content to be chunked, embedded, and stored
- [x] **KBIN-03**: User can enter a URL to fetch, scrape, chunk, embed, and store
...
| KBIN-02 | Phase 19 | Complete |
| KBIN-03 | Phase 19 | Complete |
